...
export class MPEG1Video extends BaseDecoder {
    constructor(options) {
        super(options);
        ...
        this.halfHeight = 0;
        this.currentY = null;
        this.currentY32 = null;
        this.currentCr = null;
        this.currentCr32 = null;
        this.currentCb = null;
        this.currentCb32 = null;
        this.forwardY = null;
        this.forwardY32 = null;
        this.forwardCr = null;
        this.forwardCr32 = null;
        this.forwardCb = null;
        this.forwardCb32 = null;
        // Picture layer
        this.pictureType = 0;
        this.fullPelForward = 0;
        this.forwardFCode = 0;
        this.forwardRSize = 0;
        this.forwardF = 0;
        // Slice layer
    ...
    decodePicture() {
        ...
        if (this.pictureType === MPEG1Video.PICTURE_TYPE.INTRA ||
            this.pictureType === MPEG1Video.PICTURE_TYPE.PREDICTIVE) {
            const tmpY = this.forwardY, tmpY32 = this.forwardY32, tmpCr = this.forwardCr, tmpCr32 = this.forwardCr32, tmpCb = this.forwardCb, tmpCb32 = this.forwardCb32;
    ...
    static IDCT(block) {
        ...
        // for more info.
        let b1, b3, b4, b6, b7, tmp1, tmp2, m0, x0, x1, x2, x3, x4, y3, y4, y5, y6, y7;
        // Transform columns
        for (let i = 0; i < 8; ++i) {
            b1 = block[4 * 8 + i];
...
MPEG1Video.DEFAULT_NON_INTRA_QUANT_MATRIX = new Uint8Array([
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
]);
MPEG1Video.PREMULTIPLIER_MATRIX = new Uint8Array([
...
MPEG1Video.MACROBLOCK_ADDRESS_INCREMENT = new Int16Array([
    1 * 3, 2 * 3, 0, //   0
    3 * 3, 4 * 3, 0, //   1  0
    0, 0, 1, //   2  1.
    5 * 3, 6 * 3, 0, //   3  00
...
MPEG1Video.MACROBLOCK_TYPE_INTRA = new Int8Array([
    1 * 3, 2 * 3, 0, //   0
    -1, 3 * 3, 0, //   1  0
    0, 0, 0x01, //   2  1.
    0, 0, 0x11, //   3  01.
]);
MPEG1Video.MACROBLOCK_TYPE_PREDICTIVE = new Int8Array([
    1 * 3, 2 * 3, 0, //  0
    3 * 3, 4 * 3, 0, //  1  0
    0, 0, 0x0a, //  2  1.
    5 * 3, 6 * 3, 0, //  3  00
...
MPEG1Video.MACROBLOCK_TYPE_B = new Int8Array([
    1 * 3, 2 * 3, 0, //  0
    3 * 3, 5 * 3, 0, //  1  0
    4 * 3, 6 * 3, 0, //  2  1
    8 * 3, 7 * 3, 0, //  3  00
...
MPEG1Video.MOTION = new Int16Array([
    1 * 3, 2 * 3, 0, //   0
    4 * 3, 3 * 3, 0, //   1  0
    0, 0, 0, //   2  1.
    6 * 3, 5 * 3, 0, //   3  01
...
MPEG1Video.DCT_DC_SIZE_LUMINANCE = new Int8Array([
    2 * 3, 1 * 3, 0, //   0
    6 * 3, 5 * 3, 0, //   1  1
    3 * 3, 4 * 3, 0, //   2  0
    0, 0, 1, //   3  00.
...
MPEG1Video.DCT_DC_SIZE_CHROMINANCE = new Int8Array([
    2 * 3, 1 * 3, 0, //   0
    4 * 3, 3 * 3, 0, //   1  1
    6 * 3, 5 * 3, 0, //   2  0
    8 * 3, 7 * 3, 0, //   3  11
...
MPEG1Video.DCT_COEFF = new Int32Array([
    1 * 3, 2 * 3, 0, //   0
    4 * 3, 3 * 3, 0, //   1  0
    0, 0, 0x0001, //   2  1.
    7 * 3, 8 * 3, 0, //   3  01
...
//# sourceMappingURL=mpeg1-decoder.js.map