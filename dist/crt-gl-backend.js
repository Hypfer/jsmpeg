...
export class CRTGLBackend {
    constructor(canvas, cfg, options) {
        this.width = 0;
        this.height = 0;
        this.seed = 0;
        this.cfg = cfg;
        ...
        this.gl = gl;
        this.handleLostBound = (e) => e.preventDefault();
    ...
    program(vs, fs) {
        ...
        if (!gl.getProgramParameter(p, gl.LINK_STATUS)) {
            throw new Error((_a = gl.getProgramInfoLog(p)) !== null && _a !== void 0 ? _a : 'CRT program link error');
        }
        return p;
    }
    compile(type, src) {
        ...
        if (!gl.getShaderParameter(s, gl.COMPILE_STATUS)) {
            throw new Error((_a = gl.getShaderInfoLog(s)) !== null && _a !== void 0 ? _a : 'CRT shader compile error');
        }
        return s;
    }
    locations(p, names) {
...
//# sourceMappingURL=crt-gl-backend.js.map