...
export class MP2Audio extends BaseDecoder {
    constructor(options) {
        super(options);
    ...
    decodeFrame(left, right) {
        ...
        const sync = this.bits.read(11), version = this.bits.read(2), layer = this.bits.read(2), hasCRC = !this.bits.read(1);
        if (sync !== MP2Audio.FRAME_SYNC ||
...
MP2Audio.SAMPLE_RATE = new Uint16Array([
    44100, 48000, 32000, 0, // MPEG-1
    22050, 24000, 16000, 0, // MPEG-2
]);
MP2Audio.BIT_RATE = new Uint16Array([
    32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384, // MPEG-1
    8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160, // MPEG-2
]);
MP2Audio.SCALEFACTOR_BASE = new Uint32Array([0x02000000, 0x01965fea, 0x01428a30]);
MP2Audio.SYNTHESIS_WINDOW = new Float32Array([
...
//# sourceMappingURL=mp2-decoder.js.map