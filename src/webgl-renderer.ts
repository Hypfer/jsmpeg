...
export class WebGLRenderer implements Renderer {
	...
	shouldCreateUnclampedViews = false;
	...
	private handleContextLostBound: (ev: Event) => void;
	private handleContextRestoredBound: (ev: Event) => void;
	...
	constructor(options: JSMpegOptions) {
		...
		const contextCreateOptions: WebGLContextAttributes = {
		...
		const gl =
			(this.canvas.getContext('webgl', contextCreateOptions) as WebGLRenderingContext | null) ||
